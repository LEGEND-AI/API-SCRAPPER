...
class Config:
    ...
    APP_TITLE = os.environ.get("APP_TITLE", "Gojo Api Scrapper Bot")
    APP_SHORT_NAME = os.environ.get("APP_SHORT_NAME", "Gojo Api Scrapper Bot")
    APP_URL = os.environ.get("APP_URL", "https://telegram.dog/Scrapgojouserbot")
    ...
    APP_DESCRIPTION = os.environ.get(
        "APP_DESCRIPTION",
        "created by @Gojo_satoru44"
    )
    #
    FOOTER_TEXT = os.environ.get("FTEXT", "❤️ @Gojo_satoru44")
